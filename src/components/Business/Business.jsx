import { Flex, Box, SimpleGrid, Heading, Text, Button, Stack, Divider } from "@chakra-ui/react";
...
const Business = () => {
  return (
    <Flex flexDirection="column" p={{ base: 4, md: 10 }} alignItems="center" bg="white">
      <Heading fontFamily="Montserrat" fontSize={{ base: "2xl", md: "48px" }} textAlign="center" mb={2}>
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={1} alignItems="center" maxW="1400px">
        ...
        <Box zIndex={1}>
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
            ...
            >
              <Heading size="md" mb={2}>Achieve Goals</Heading>
            ...
            <Stack
              ...
              color="white"
            >
              <Heading size="md" mb={2}>Campaign Manage</Heading>
              <Divider mb={4} borderBottom="2px" borderColor="gray.200" />
            ...
            <Stack
              ...
              borderColor="gray.200"
            >
              <Heading size="md" mb={2}>Brand Development</Heading>
              <Divider mb={4} borderBottom="2px" borderColor="gray.200" />
      ...
      {/* <Box
        ...
        zIndex={0}
      /> */}
      <Button mt={8} color="white" bg="#66B2C2" borderRadius="full" size="lg" _hover={{ bgGradient: "linear(to-r, teal.400, green.400)" }}>
        View More
      </Button>
    </Flex>
  );
